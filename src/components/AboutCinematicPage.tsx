...
const HISTORY_SECTIONS = [
  ...
  },
  {
    ...
    tag: 'Εξέλιξη',
    heading: 'Σταθερή\nΑνάπτυξη',
    body: 'Με την πάροδο των ετών, η AEROFREN εξελίχθηκε σε έναν ολοκληρωμένο B2B προμηθευτή, εντάσσοντας στο δυναμικό της ένα ευρύ φάσμα προϊόντων πεπιεσμένου αέρα. Σήμερα, η επιχείρηση συνεχίζει την επιτυχημένη πορεία της υπό τη διεύθυνση της κόρης του ιδρυτή, Κατερίνας Κουτελίδου.',
    align: 'right',
  },
  {
    id: 'location',
