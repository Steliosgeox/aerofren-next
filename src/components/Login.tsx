...
import { Lock, Mail, Eye, EyeOff, ArrowRight, Check, Droplets, Github, Loader2 } from 'lucide-react';
...
export default function Login() {
    ...
    // Handle form submit (email/password - for future implementation)
    const handleFormSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setError('Η σύνδεση με email/password δεν είναι διαθέσιμη ακόμα. Χρησιμοποιήστε το Google.');
    };
                ...
                >
                    ...
                    <div className="flex flex-col lg:flex-row min-h-[600px]">
                        ...
                        <div className="flex-1 p-8 space-y-6">
                            ...
                            {/* Error Message */}
                            {error && (
                                <div className="p-3 rounded-xl text-sm text-red-400 bg-red-500/10 border border-red-500/20">
                                    {error}
                                </div>
                            )}
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    className="w-full py-3 px-4 rounded-xl font-medium border transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02]"
                                    style={{
                                ...
                                >
                                    ...
                                    <span>{isSigningIn ? 'Σύνδεση...' : 'Συνέχεια με Google'}</span>
                                </button>

                                <button
                                    type="button"
                                    disabled
                                    className="w-full py-3 px-4 rounded-xl font-medium border transition-all duration-300 flex items-center justify-center space-x-2 opacity-50 cursor-not-allowed"
                                    style={{
                                        background: 'var(--social-bg)',
                                        borderColor: 'var(--glass-border)',
                                        color: 'var(--text-primary)'
                                ...
                                >
                                    ...
                                    <span>Continue with GitHub (Σύντομα)</span>
                                </button>
                            </div>
